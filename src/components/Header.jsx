...
function Header() {
  ...
  return (
    <header className="bg-darkBlue h-[60px] flex items-center px-4 justify-between text-white md:h-[100px] lg:px-[10%]">
      ...
      {userDetails?<Link to='/user-dashboard'><FaUserCircle  className="text-2xl md:text-3xl"/></Link>:<Link to="/login" className=" bg-primaryBlue rounded-xl p-2 px-4 md:text-xl">Login</Link>}
    </header>
  );
}
